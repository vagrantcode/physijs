...
Physijs.CylinderMesh = class extends Mesh {
  constructor(geometry, material, mass) {
    super(geometry, material, mass);
...
// Physijs.CapsuleMesh
Physijs.CapsuleMesh = class extends Mesh {
  constructor(geometry, material, mass) {
    super(geometry, material, mass);
    var width, height, depth;
...
// Physijs.ConeMesh
Physijs.ConeMesh = class extends Mesh {
  constructor(geometry, material, mass) {
    super(geometry, material, mass);
...
// Physijs.ConcaveMesh
Physijs.ConcaveMesh = class extends Mesh {
  constructor(geometry, material, mass) {
    super(geometry, material, mass);
...
// Physijs.ConvexMesh
Physijs.ConvexMesh = class extends Mesh {
  constructor(geometry, material, mass) {
    super(geometry, material, mass);
